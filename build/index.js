...
const defineCustomClassName = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(BlockListBlock => {
  return props => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockListBlock, {
      ...props,
      className: classnames__WEBPACK_IMPORTED_MODULE_6___default()(props.className || "", props.attributes.customClassNames)
    });
  };
...
function addCustomClassInFront(extraProps, blockType, attributes) {
  ...
  if (!addedCustomClass) {
    ...
    extraProps.className = classnames__WEBPACK_IMPORTED_MODULE_6___default()(extraProps.className || "", attributes.customClassNames || "");
...
/* eslint-disable */
console.log(...oo_oo(`1965843327_116_0_116_34_4`, "script executing..."));
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */
;
function oo_cm() {
  try {
